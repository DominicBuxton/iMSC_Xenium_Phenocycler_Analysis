...
path = "D:/Dom/Fibrosis project/4th year data - update location/DPOC_RBLA_XENIU_2_Scan1.er.qptiff" //path to qptiff image from phenocycler
numChannels = 25 //number of protein channels used
